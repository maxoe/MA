...
\begin{figure}[hbtp]
	...
	\caption{The running time of goal-directed core CH queries increases with a decreasing assumed maximum speed of the vehicle.}
\end{figure}
